...
export const FireKeeperHistorySection: React.FC = () => {
  ...
  const milestones: MilestoneItem[] = [
    {
      ...
      content: (
        <div className="space-y-3">
          ...
          <p className="text-slate-300 leading-relaxed">
            จุดเริ่มต้นอยู่ที่ <strong className="text-amber-400 font-semibold">ชื่อและตัวตนของ ปุญญ์</strong>
          </p>
          <p className="text-slate-300 leading-relaxed">
          ...
          <div className="p-4 rounded-xl bg-amber-500/10 border border-amber-500/30 text-amber-200 font-medium italic my-2">
            <Quote className="w-4 h-4 text-amber-400 mb-1 inline mr-1 opacity-70" />
      ...
      content: (
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 my-2">
            <div className="p-3.5 rounded-xl bg-slate-900/80 border border-orange-500/30 space-y-1">
              <span className="text-xs font-mono font-bold text-orange-400 block uppercase">“ไฟ” (The Fire)</span>
            ...
            <div className="p-3.5 rounded-xl bg-slate-900/80 border border-amber-500/30 space-y-1">
              <span className="text-xs font-mono font-bold text-amber-400 block uppercase">“ผู้รักษา” (The Keeper)</span>
              <p className="text-xs text-slate-300 leading-relaxed">
                ไม่ได้หมายถึงผู้ที่ครอบครองไฟ แต่หมายถึงผู้ที่ <strong className="text-amber-300">รักษาไฟไม่ให้ดับ</strong>
              </p>
            </div>
          </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          ...
          <div className="p-4 rounded-xl bg-sky-500/10 border border-sky-500/30 text-sky-200 font-medium italic my-2">
            <Quote className="w-4 h-4 text-sky-400 mb-1 inline mr-1 opacity-70" />
          ...
          <div className="p-3 rounded-xl bg-slate-900 border border-slate-700 text-xs font-semibold text-emerald-400">
      ...
      content: (
        <div className="space-y-3">
          ...
          <div className="p-3.5 rounded-xl bg-purple-950/40 border border-purple-500/30 space-y-2">
            ...
            <div className="flex flex-wrap items-center gap-1.5 font-mono text-[11px] text-purple-200">
              <span className="px-2 py-1 rounded bg-purple-900/60 border border-purple-500/30">ข้อมูล (Data)</span>
              <ArrowRight className="w-3 h-3 text-purple-400" />
              <span className="px-2 py-1 rounded bg-purple-900/60 border border-purple-500/30">การตีความ (Interpret)</span>
              <ArrowRight className="w-3 h-3 text-purple-400" />
              <span className="px-2 py-1 rounded bg-purple-900/60 border border-purple-500/30">การวิเคราะห์ (Analyze)</span>
              <ArrowRight className="w-3 h-3 text-purple-400" />
              <span className="px-2 py-1 rounded bg-purple-900/60 border border-purple-500/30">การสังเคราะห์ (Synthesize)</span>
              <ArrowRight className="w-3 h-3 text-purple-400" />
              <span className="px-2 py-1 rounded bg-purple-900/60 border border-purple-500/30">พิจารณาทางเลือก (Options)</span>
              <ArrowRight className="w-3 h-3 text-purple-400" />
              <span className="px-2 py-1 rounded bg-emerald-900/60 text-emerald-300 border border-emerald-500/40 font-bold">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs font-mono">
            {[
              ...
              <div key={tag} className="p-2 rounded-lg bg-indigo-950/50 border border-indigo-500/30 text-indigo-300 text-center font-semibold">
                {tag}
              </div>
            ))}
          </div>
        ...
        <div className="space-y-3">
          ...
          <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800 space-y-2 text-xs font-mono">
            <div className="flex items-center justify-between py-1 border-b border-slate-800">
              <span className="text-amber-400 font-bold">Firekeeper</span>
              <span className="text-slate-300">กำหนดแนวคิดและเป้าหมาย (Purpose & Ethics)</span>
            </div>
            <div className="flex items-center justify-between py-1 border-b border-slate-800">
              <span className="text-purple-400 font-bold">PCA</span>
              <span className="text-slate-300">กำหนดสถาปัตยกรรมการคิด (Cognitive Structure)</span>
            </div>
            <div className="flex items-center justify-between py-1">
              <span className="text-sky-400 font-bold">AI / LLM</span>
              <span className="text-slate-300">ทำหน้าที่ประมวลผล (Computational Processing)</span>
            </div>
          </div>
        </div>
      ),
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs font-mono">
            {['Authentication', 'AI Analysis', 'PDF Analysis', 'User Management', 'Security', 'Analytics', 'Enterprise Web Architecture', 'Zero-PII Telemetry'].map((item) => (
              <div key={item} className="p-2 rounded-lg bg-slate-900 border border-slate-800 text-slate-300 text-center font-medium">
                ✓ {item}
              </div>
            ))}
          </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          ...
          <p className="text-slate-300 text-xs leading-relaxed">
            จากจุดเริ่มต้นที่เกิดจาก <strong>ชื่อและตัวตน</strong> → มาสู่คำถามเรื่อง <strong>ความหมายและการดำรงอยู่</strong> → ต่อยอดเป็นแนวคิดเรื่อง <strong>การรักษาไฟ</strong> → พัฒนาเป็น <strong>กรอบความคิด</strong> → กลายเป็น <strong>PUNN Cognitive Architecture</strong> → ขยายไปสู่ <strong>Firekeeper Unified Theory</strong> → และในที่สุดถูกสร้างขึ้นเป็น <strong>AI system และ firekeeper.site</strong>
          </p>
          <div className="p-5 rounded-2xl bg-gradient-to-r from-amber-500/20 via-orange-500/15 to-emerald-500/20 border border-amber-500/40 text-center space-y-2 my-2 shadow-lg">
  ...
  return (
    <div className="space-y-6">
      {/* Header Banner */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-950/60 via-slate-900 to-[#0B1220] border border-amber-500/30 p-6 sm:p-8 shadow-2xl">
          ...
          .map((m, index) => {
            ...
            return (
              <div 
                ...
                className="p-5 sm:p-6 rounded-2xl bg-slate-900/90 border border-slate-800 hover:border-slate-700 transition-all shadow-xl space-y-4"
              >
                {/* Chapter Header */}
