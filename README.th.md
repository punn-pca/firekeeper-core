...
> **สถานะใบอนุญาต:** เวอร์ชันปัจจุบันของ repository เป็น source-available ภายใต้ Business Source License 1.1 (BSL 1.1) ไม่ใช่ Open Source license อนุญาตให้ใช้แบบ non-production; การใช้ใน production ต้องมี commercial license แยกต่างหาก เว้นแต่ `LICENSE` จะระบุ Additional Use Grant ไว้ โปรดดู [`LICENSE`](LICENSE) และ [`NOTICE`](NOTICE) ส่วนเวอร์ชันเก่าที่เคยเผยแพร่ภายใต้ Apache License 2.0 ยังคงอยู่ภายใต้สิทธิ์เดิมของเวอร์ชันนั้น
